...
//var AlienAnimations = map[string]*Animation{}
...
func buildAlienAnimation() Animation {
	...
	//
	//w, h = artCache["Alien_exp_0_0"].Size()
	//AlienAnimations["Alien_exp_0"] = &Animation{
	//	frames: []*ebiten.Image{
	//		artCache["Alien_exp_0_0"],
	//		artCache["Alien_exp_0_1"],
	//		artCache["Alien_exp_0_2"],
	...
	//	w:     w, h: h,
	//}
	//w, h = artCache["Alien_1_0"].Size()
	//AlienAnimations["Alien_1"] = &Animation{
	//	frames: []*ebiten.Image{
	//		artCache["Alien_1_0"],
	//		artCache["Alien_1_1"],
	//		artCache["Alien_1_2"],
	...
	//	w:     w, h: h,
	//}
	//w, h = artCache["Alien_2_0"].Size()
	//AlienAnimations["Alien_2"] = &Animation{
	//	frames: []*ebiten.Image{
	//		artCache["Alien_2_0"],
	//		artCache["Alien_2_1"],
	//		artCache["Alien_2_2"],
